...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $sql = "SELECT id FROM adminusers WHERE username = ?";
      ...
      <div class="logo">
        <img src="Image/Logonow.png"
           ...
           <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <!-- Create USERNAME -->
            <h3 class="userlabel">Create Username</h3>
          ...
          <br><br>
            ...
            <!-- Create PASSWORD -->
            <h3 class="passlabel">Create Password</h3>
            <div class="input-box">
                ...
                <br> <br>
                <!-- Confirm PASSWORD -->
            <h3 class="passlabel">Confirm Password</h3>
            <div class="input-box">
            ...
            <div class="register-link">
                <p class="accountlabel">Do you have an admin account? 
                <a href="login_account.php">Login Here</a>
                </p>
            </div>
        </form>
    </div>
