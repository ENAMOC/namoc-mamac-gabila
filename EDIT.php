<?php require_once("configpost.php"); $id=$_GET['id']; ?>
...
<label class="image-label">IMAGE REVIEW</label> <br><br>
<img src="uploads/<?php echo $image;?>" height="250" class="image-edit"><br><br> 
<label class="image-label">CHANGE PHOTO</label>
<input type="file" name="image" class="form-picture"> <br><br>
<label class="description-label">DESCRIPTION</label><br><br>
<textarea type="text" name="title" class="text-description"><?php echo $title;?></textarea><br><br>
<button name="update_submit" class="btn-upload">UPDATE</button><br><br>
</form>
